 ...
 * @param versionInfo All messages from the node carry the version info and received messages are checked against this for compatability.
 ...
 * @param advertisedAddress The externally advertised version of the Artemis broker address used to construct myAddress and incldued
        ...
        state.locked {
            ...
            if (serviceIdentity != null) {
                ...
                serviceHandler.setMessageHandler { msg ->
                    val redirect = msg.copy()
                    artemis.started!!.producer.send(inbox, redirect)
