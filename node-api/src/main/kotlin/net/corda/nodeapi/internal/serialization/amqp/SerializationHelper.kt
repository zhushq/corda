 ...
 */
internal fun <T : Any> propertiesForSerialization(kotlinConstructor: KFunction<T>?, type: Type, factory: SerializerFactory): List<PropertyAccessor> {
    return if (kotlinConstructor != null) {
        ...
        this.sortedWith(PropertyAccessor)
    }
}
        ...
        kotlinConstructor.parameters.withIndex().forEach { param ->
            ...
            val propertyReader = if (name in properties) {
                ...
                try {
                    ...
                    Pair(PrivatePropertyReader(field, type), type)
            ...
            this += PropertyAccessor.ProperAccessorConstructor(
                    param.index,
...
private fun propertiesForSerializationFromSetters(
        ...
        type: Type,
        factory: SerializerFactory): List<PropertyAccessor> {
    return mutableListOf<PropertyAccessor.ProperAccessorGetterSetter>().apply {
        properties.forEach { property ->
            ...
            this += PropertyAccessor.ProperAccessorGetterSetter (
...
private fun propertiesForSerializationFromAbstract(
   ...
   return mutableListOf<PropertyAccessor.ProperAccessorConstructor>().apply {
